...
/**
 * A classe CampoHarmonico representa um programa que gera o campo harmônico de uma tonalidade.
 * O campo harmônico é uma sequência de acordes que são construídos a partir de uma escala musical.
 * O programa solicita ao usuário que insira a tônica e o tipo de escala, e em seguida gera e imprime o campo harmônico correspondente.
 */
public class CampoHarmonico {
    ...
    * Ele solicita ao usuário que insira a tônica e o tipo de escala,
    * gera o campo harmônico com base na entrada e o imprime.
    *
    ...
    */
     ...
     * @param tipoDeEscala O tipo de escala (maior ou menor) para gerar o campo harmônico.
     ...
     *
     * @param tonica a tonalidade para a qual se deseja determinar a relativa maior
     * @return a tonalidade relativa maior da tonalidade dada, ou "C" se não for encontrada
     */
 ...
 * 
 * Este método preenche o mapa 'escalasMaiores' com as escalas maiores e suas respectivas notas.
 * Cada escala é representada por uma chave (tom) e uma lista de notas.
 */
...
/**
 * Inicializa o mapa de relativas maiores.
 * As relativas maiores são pares de acordes onde um acorde é a relativa maior do outro.
 * O mapa é preenchido com as relativas maiores para cada acorde.
 */
